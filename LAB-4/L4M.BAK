...
int main()
{
	...
	printToWithColor("724402-2  L4  Chernyavsky Y.A.  Podsistema prerivaniy", 0x04, 0, 0);// Функция вывода в консоль через видеопамять в произвольное место с заданным цветом
	printToWithColor("1. Clear screen  2. Change scancode color  3. Divide by zero  4. Exit", 0x0E, 0, 1);// Функция вывода в консоль через видеопамять в произвольное место с заданным цветом
